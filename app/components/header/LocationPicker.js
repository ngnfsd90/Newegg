    ...
    <>
      <div className="relative">
        <button
          ...
          className={`text-white flex items-center space-x-1 sm:space-x-2 rounded-full transition-all flex-shrink-0 ${
            darkMode
      ...
      {isOpen && (
        <div
          ...
          } border rounded-lg p-4 sm:p-6 w-[90vw] sm:w-80 md:w-96 rtl shadow-xl z-[60] max-h-[calc(100vh-80px)] overflow-y-auto`}
          style={{
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-gray-600 mb-4">
            لطفاً یک کشور / منطقه برای خرید انتخاب کنید:
          </p>
